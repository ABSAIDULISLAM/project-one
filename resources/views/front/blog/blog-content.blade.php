...
<div class="article">
    ...
    <div class="clr"></div>
    <div class="comment"> <a href="#"><img src="{{asset('/font')}}/images/userpic.gif" width="40" height="40" alt="" class="userpic" /></a>
...
<div class="article">
    ...
    <form action="#" method="post" id="leavereply">
        <ol>
            ...
            <li>
                <input type="image" name="imageField" id="imageField" src="{{asset('/font')}}/images/submit.gif" class="send" />
                <div class="clr"></div>
            </li>
        </ol>
    </form>
